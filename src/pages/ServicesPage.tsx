import svgPaths from "./svg-6oubls6pq0";
...
function Frame59() {
  return (
    <div className="-translate-y-1/2 [word-break:break-word] absolute content-stretch flex flex-col gap-[24px] items-center justify-center left-[223px] not-italic text-center text-white top-[calc(50%-50px)] w-[875px]">
      <div className="font-['Inria_Serif:Bold',sans-serif] leading-[0] min-w-full relative shrink-0 text-[64px] w-[min-content]">
        <p className="leading-[normal] mb-0">Engineering teams for</p>
        <p>
          <span className="leading-[normal] text-[#fb0]">{`Japan `}</span>
          <span className="leading-[normal] text-white">and</span>
          <span className="leading-[normal] text-[#fb0]">{` APAC.`}</span>
        </p>
      </div>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[20px] w-[835px]">From hiring and BOT transfers to managed teams and EOR services, we help companies expand across APAC with confidence.</p>
    </div>
  );
}
...
function ServicePageHeroSection() {
  return (
    <div className="-translate-x-1/2 absolute h-[736px] left-1/2 overflow-clip top-[87px] w-[1320px]" data-name="service page hero section">
...
function Services() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[42px] items-center left-1/2 top-[887px] w-[1160px]" data-name="services">
      <Frame14 />
      <Frame32 />
    </div>
  );
...
function Frame21() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-center relative shrink-0 w-full">
      <div className="[word-break:break-word] font-['Inria_Serif:Bold',sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[#252525] text-[48px] text-center w-[min-content]">
        <p className="leading-[normal] mb-0">Not sure</p>
        <p className="font-['Georgia:Italic',sans-serif] leading-[normal] text-[#039]">which service fits?</p>
      </div>
      <div className="bg-gradient-to-r from-[0.481%] from-white h-[4px] relative shrink-0 to-white via-1/2 via-[#039] w-[240px]" />
    </div>
  );
...
function Frame39() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
      <Frame21 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#4f4f4f] text-[16px] text-center w-full">{`Book a conversation. We'll map your needs to the right engagement — honestly and in your language.`}</p>
    </div>
  );
}
...
function TapNavBar() {
  return (
    <div className="absolute bottom-0 h-[2958px] left-0 pointer-events-none top-0">
...
export default function ServicesPage() {
  return (
    <div className="bg-white relative size-full" data-name="services page">
